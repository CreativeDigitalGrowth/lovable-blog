...
| Hosting | Not yet decided — placeholder config assumes a root-served static host | — |
...
code. **Every internal link, asset reference and absolute URL still goes through
